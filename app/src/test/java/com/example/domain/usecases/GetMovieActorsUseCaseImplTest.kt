...
internal class HomeViewModelTest {
    ...
    @Test
    fun `test get popular movies`() = runBlockingTest {
        // Given
        val popularMovies = ListMovies(1, results = listOf(
            Movie(id = 1, genres = listOf("crime"), originalLanguage = "english", overview = "", originalTitle = "hello", releaseDate = "1990-09-19", voteAverage = 4.32, voteCount = 32, backdropPath = null, posterPath = "", title = "title", popularity = 4.32),
            Movie(id = 2, genres = listOf("crime"), originalLanguage = "english", overview = "", originalTitle = "hello", releaseDate = "1990-09-19", voteAverage = 4.32, voteCount = 32, backdropPath = null, posterPath = "", title = "title", popularity = 4.32),
            ))

        `when`(getPopularMoviesUseCase.getPopularMovies(any())).thenReturn(flowOf(Resource.Loading(popularMovies)))
